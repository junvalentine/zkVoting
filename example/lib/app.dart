...
class _HomePageTypeinState extends State<HomePageTypein> {
  ...
  final TextEditingController controller3 = TextEditingController(text: "16052028");
  @override
  void deactivate() {
    super.deactivate();
  }
              ...
              child: RichText(
                ...
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                      text:
                          'Please ensure that you have a stable internet connection during the voting process.',
